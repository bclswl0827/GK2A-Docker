...
RUN export DIR_TMP="$(mktemp -d)" \
  ...
  && curl -L -o ${DIR_TMP}/EncryptionKeyMessage_001F2904C905.bin https://cdn-static.ibcl.us/GK2A-Decode_20190811/EncryptionKeyMessage_001F2904C905.bin \
  ...
  && rm -rf ${DIR_TMP}/dotnet-runtime.tar.gz \
